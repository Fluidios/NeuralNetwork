...
#region Preparing data for training
...
model.fit(
    ...
    batch_size=128, 
    n_epoch=30)
print('NN learning takes: {0}'.format(time.time()-timer))
#endregion

#region Save trained NN to file
model.save(SAVED_NN)
print('NN saved to file.')
#endregion
